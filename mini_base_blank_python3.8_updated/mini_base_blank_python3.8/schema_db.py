...
class Schema(object):
    ...
    def deleteAll(self):
        ...
        :对源代码进行了修改, tableFields 应该是空字典
        """
        # 正确初始化数据结构
        self.headObj.tableFields = {}  # 应该是空字典
        self.headObj.tableNames = []   # 空列表
